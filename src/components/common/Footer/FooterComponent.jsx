...
const FooterComponent = () => {
  return (
    <footer className="footerComp bg-chatter-blue footer-height text-white">
      ...
      <div className="mx-1">
        <Link className="colorLinks" to='/about'>
          Equipo de Desarrollo
        </Link>
      </div>
      </div>
      <div className="d-flex justify-content-center align-items-center">
        <a className="" href="https://twitter.com/" rel="noreferrer" target="_blank">
        ...
        <a className="d-flex mx-3" href="https://discord.com/"  rel="noreferrer" target="_blank">
          <svg height="24" viewBox="0 0 24 24" width="24">
        ...
        <a className="" href="https://github.com/" rel="noreferrer" target="_blank">
